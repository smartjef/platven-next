      ...
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        ...
        <div>
          <div className="w-80 rounded bg-gray-50 px-6 pt-8 shadow-lg">
            <img
              src={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/platven_logo.png`}
              alt="chippz"
              className="mx-auto w-16 py-4"
            />
            <div className="flex flex-col justify-center items-center gap-2">
              <h4 className="font-semibold">Platven Limited</h4>
              <p className="text-xs">Thika Road,Juja Town</p>
            </div>
            <div className="flex flex-col gap-3 border-b py-6 text-xs">
              <p className="flex justify-between">
                <span className="text-gray-400">Receipt No.:</span>
                <span>{payment.mpesareceiptNumber}</span>
              </p>
              <p className="flex justify-between">
              ...
              <p className="flex justify-between">
                ...
                <span>Platven Limited</span>
              </p>
              <p className="flex justify-between">
                <span className="text-gray-400">Customer:</span>
                <span>{payment.property.user.name}</span>
              </p>
            </div>
            <div className="flex flex-col gap-3 pb-6 pt-2 text-xs">
              <table className="w-full text-left">
                <thead>
                  <tr className="flex">
                    <th className="w-full py-2">Property</th>
